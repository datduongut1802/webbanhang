    ...
    return (
        <section className="w-full my-6" id="menu">
            <div className="w-full flex flex-col items-center justify-center">
                ...
                <div className="w-full flex items-center justify-start lg:justify-center gap-8 py-6 mt-6 overflow-x-scroll 
                scrollbar-none">
                    {categories && categories.map(category => (
                        <motion.div
                            ...
                            hover:bg-cartNumBg justify-center duration-100 transition-all ease-in-out`}
